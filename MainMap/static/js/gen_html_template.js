        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="section-title">
                    <h2><a target="_blank" href=${currentLocation['url']}>${currentLocation['title']}</a></h2>
            ...
            <div class="modal-body">
                ...
                <p>${ currentLocation['description'].replace("\n", "<br>") }</p>
                <!--end right-->
            </div>
            <!--end modal-body-->
        </div>
                            ...
                            //<div class="result-item-detail">`
                                ...
                                <div class="description">`;
                                    ...
                                    if( data[i]['description'] != undefined ){
                                        let des = data[i]['description'].substr(0,100).replace('\n','</br>');
